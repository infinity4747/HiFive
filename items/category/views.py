...
class GetView(ListAPIView,RetrieveUpdateAPIView,RetrieveUpdateDestroyAPIView):
    ...
    def get(self, request, pk):
        try:
        	...
        	return Response({"status":"successful","category": serializer.data})
        except:
        	return Response({"status":"error"})
...
class PostView(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            return Response({'status': 'You have successfully register'})
        except:
        	return Response({'status': 'error'})
...
class GetProductView(ListAPIView,RetrieveUpdateAPIView,RetrieveUpdateDestroyAPIView):
    ...
    def get(self, request, pk):
        try:
        	...
        	return Response({"status":"successful","product": serializer.data})
        except:
        	return Response({"status":"error"})
...
class PostProductView(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
            ...
            self.perform_create(serializer)
            headers = self.get_success_headers(serializer.data)
            return Response({'status': 'You have successfully create'})
